    ...
    public class Insights
    {
        ...
        public Insights(int adapterResponseType, string adapterResponse)
        {
            ...
            else if (adapterResponseType == Banner)
            {
                ...
                if (banner != null)
                {
                    _banner = new AdInsight(Adapter.AdType.Banner, banner);
                    Insight = _banner;
                }
            }
            else if (adapterResponseType == Interstitial)
            {
                ...
                {
                    _interstitial = new AdInsight(Adapter.AdType.Interstitial, interstitial);
            ...
            else if (adapterResponseType == Rewarded)
            {
                ...
                if (rewarded != null)
                {
                    _rewarded = new AdInsight(Adapter.AdType.Rewarded, rewarded);
                    Insight = _rewarded;
                }
            }
        }
